    ...
    <div className="landing-page">
      <nav className="landing-nav">
        <span className="landing-logo">
          <span className="landing-logo-mark">&lt;/&gt;</span> ECHO DEV
        </span>
      ...
      <section className="landing-hero">
        <div className="landing-hero-content">
          ...
          <p className="landing-hero-subtitle">
            Describe what you want to build in plain English. ECHO DEV generates
          ...
          <div className="landing-stats">
            ...
            <div className="landing-stat">
              ...
              <span className="landing-stat-label">Powered by AI</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="landing-footer">
        <div className="landing-footer-content">
          ...
          <p className="landing-footer-text">Built with AI. Powered by ECHO DEV.</p>
        </div>
      </footer>
    </div>
  );
